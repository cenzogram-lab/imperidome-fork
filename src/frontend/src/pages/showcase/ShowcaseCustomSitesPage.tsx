    ...
    <div style={{ background: "#0A0B14", minHeight: "100vh" }}>
      ...
      >
        ...
        <div style={{ marginBottom: "16px" }}>
          ...
          >
            <EditableText
              textKey="showcase.custom_sites.eyebrow"
          ...
          >
            <EditableText
              textKey="showcase.custom_sites.hero_title"
          ...
          >
            <EditableText
              textKey="showcase.custom_sites.hero_tagline"
              defaultText="See our Custom Sites in action"
            />
          </p>
        </div>
      </section>
      ...
      >
        ...
        >
          <EditableText
            textKey="showcase.custom_sites.section_heading"
