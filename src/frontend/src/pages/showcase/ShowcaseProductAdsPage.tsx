...
const PLACEHOLDER_CARDS = [
  {
    title: "Flash One-Shot",
    description: "Single 15s ultra-HD product reveal, 48hr delivery.",
    videoKey: "showcase_product_ads_video_1",
  },
  {
    title: "Starter Pack — Month 1",
    description: "3 sensory hooks produced within 24 hours.",
    videoKey: "showcase_product_ads_video_2",
  },
  {
    title: "Scale Package — Month 1",
    description: "5 hooks with permanent Vault storage.",
    videoKey: "showcase_product_ads_video_3",
  },
  {
    title: "Scale Package — Month 2",
    description: "5 follow-up hooks for an ongoing campaign.",
    videoKey: "showcase_product_ads_video_4",
  },
  {
    title: "Product Identity Lock",
    description: "Proprietary visual identity locked in for a brand.",
    videoKey: "showcase_product_ads_video_5",
  },
  {
    title: "Surreal Physics Showcase",
    description: "Physics-driven product video for a skincare brand.",
    videoKey: "showcase_product_ads_video_6",
  },
];

export default function ShowcaseProductAdsPage() {
